...
public class AccountsController {
	...
	@Timed(value="accounts.getAccountDetails.time", description = "Latency for the /myAccount api call in accounts microservice")
	...
	@Timed(value="accounts.myCustomerDetails.time", description = "Latency for the /myCustomerDetails api call in accounts microservice")
	...
	@Timed(value="accounts.config.time", description = "Latency for the /accounts-microservice/config api call in accounts microservice")
